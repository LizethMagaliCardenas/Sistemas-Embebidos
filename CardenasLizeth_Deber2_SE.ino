 ...
 * DEBER 2: Manejo de display 7 segmentos multiplexados cátodo común con decodificador
 *           7447
 * Objetivo: Se registra las veces que se presiona un pulsador en números primos del 0 al 99
...
if(digitalRead(boton)==HIGH){ // condición que active el sw en alto
  ...
  if(cont<=20){               // conteo máximo a visualizar
    ...
    else                      //condición límite de conteo 
